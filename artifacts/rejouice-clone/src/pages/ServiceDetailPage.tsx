    ...
    <div ref={pageRef} className="bg-white text-[#0A0A0A] pt-24">
      ...
      <section className="max-w-[1400px] mx-auto px-6 md:px-10 pt-16 pb-0 md:pt-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pb-16">
          <div>
            <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-6">{page.tagline}</p>
            <h1
      ...
      <section className="bg-[#F5F4F0] py-24 md:py-32">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div className="reveal">
            <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-6">What we do</p>
            <p className="font-sans font-light text-[#0A0A0A] leading-[1.6]" style={{ fontSize: "clamp(1rem, 1.6vw, 1.2rem)" }}>
              {page.what}
            </p>
          </div>
          <div className="reveal">
            <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-6">How we do it</p>
            <p className="font-sans font-light text-[#0A0A0A] leading-[1.6]" style={{ fontSize: "clamp(1rem, 1.6vw, 1.2rem)" }}>
              {page.how}
            </p>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto px-6 md:px-10 mt-16 reveal">
          <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-6">Deliverables</p>
      ...
      <section className="process-section py-24 md:py-32 bg-white">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-12 reveal">Our process</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {page.process.map(({ step, title, body }) => (
              <div key={step} className="process-step border-t-2 border-[#0A0A0A]/10 pt-6">
                <p className="font-sans text-[11px] uppercase tracking-widest text-[#0A0A0A]/25 mb-4">{step}</p>
      ...
      <section className="projects-section bg-[#0A0A0A] py-24 md:py-32">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-white/30 mb-12">Related work</p>
      ...
      {page.faqs.length > 0 && (
        <section className="py-24 md:py-32 bg-white">
          <div className="max-w-[1400px] mx-auto px-6 md:px-10">
            <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-12 reveal">Common questions</p>
              ...
              {page.faqs.map((faq) => (
                <div key={faq.q} className="reveal border-t border-[#0A0A0A]/10 last:border-b">
                  ...
                  >
                    ...
                    <span className="text-[#0A0A0A]/40 text-lg shrink-0 transition-transform duration-300">+</span>
                  </button>
      ...
      <section className="bg-[#F5F4F0] py-24 md:py-32">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-[#0A0A0A]/35 mb-10 reveal">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {(isIndustryService ? siblingIndustry : otherCoreServices).map((s) => (
              ...
              >
                <p className="font-sans text-[11px] uppercase tracking-widest text-[#0A0A0A]/30 mb-3 group-hover:text-[#0A0A0A]/50 transition-colors">{s.industryName || "Service"}</p>
                ...
                <p className="font-sans text-xs text-[#0A0A0A]/40">{s.tagline}</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="bg-[#0A0A0A] text-white py-28 md:py-36">
        <div className="max-w-[1400px] mx-auto px-6 md:px-10">
          <p className="font-sans text-[11px] uppercase tracking-[0.18em] text-white/30 mb-8 reveal">Start your project</p>
          <h2
