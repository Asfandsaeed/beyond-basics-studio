...
export const posts: JournalPost[] = [
  // ─── 1. MultiversX ────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "image", src: `${IMG}/aJfdrKTt2nPbaHC-_Brand-Hero.jpg?auto=format,compress&w=2400`, alt: "MultiversX brand system", caption: "The MultiversX visual system — precision meets infinite scale." },
  ...
  // ─── 2. Brand-Led Growth ──────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "image", src: `${IMG}/aJfdrKTt2nPbaHC-_Brand-Hero.jpg?auto=format,compress&w=2400`, alt: "Clear Street brand system", caption: "Clear Street established brand authority in capital markets before a single sales conversation began." },
  ...
  // ─── 3. Keikku ───────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "image", src: `${IMG}/Z218g5bqstJ981rD_oura-abdul-ovaice-photography-cd-3.jpg?auto=format,compress&w=2400`, alt: "Keikku brand photography", caption: "Brand photography that put the human at the centre — not the device." },
      ...
      { type: "image", src: `${IMG}/Z218opbqstJ981rL_Group3919.png?auto=format,compress&w=2400`, alt: "Keikku visual identity system", caption: "A visual system built for the intersection of clinical precision and human warmth." },
  ...
  // ─── 5. Kōzōwood ───────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "image", src: `${IMG}/Z22KFpbqstJ981ua_IMG_87781.png?auto=format,compress&w=2400`, alt: "Kōzōwood construction", caption: "Where precision engineering meets natural material — the Kōzōwood brand world." },
  ...
  // ─── 8. Phive ─────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      { type: "image", src: `${IMG}/aFMcJLNJEFaPYFRB_Rivian-02.jpg?auto=format,compress&w=2400`, alt: "Phive brand system", caption: "Phive's visual world — precision fitness, community, and a clear sense of where you belong." },
      ...
      { type: "image", src: `${IMG}/aFMcKrNJEFaPYFRJ_Rivian-10.jpg?auto=format,compress&w=2400`, alt: "Phive digital experience", caption: "The Phive digital experience — arriving in new markets before the doors open." },
